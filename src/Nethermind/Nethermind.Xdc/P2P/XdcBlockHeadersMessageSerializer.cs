...
/// <summary>
/// XDC-specific BlockHeadersMessageSerializer that uses XdcHeaderDecoder
/// to properly decode 18-field XDC block headers with Validators/Validator/Penalties fields.
/// </summary>
public class XdcBlockHeadersMessageSerializer : IZeroInnerMessageSerializer<BlockHeadersMessage>
{
    ...
    public XdcBlockHeadersMessageSerializer(IHeaderDecoder headerDecoder)
    {
        _headerDecoder = headerDecoder ?? new XdcHeaderDecoder();
    }
