...
internal class XdcInitializeBlockchain(INethermindApi api, IChainHeadInfoProvider chainHeadInfoProvider) : IStep
{
    ...
    protected IComparer<Transaction> CreateTxPoolTxComparer() =>
        new XdcTransactionComparerProvider(_api.SpecProvider!, _api.BlockTree!).GetDefaultComparer();
}
